  ...
  render() {
    return (
      <div class="container">
        ...
        <FontAwesomeIcon onClick={() => window.location.reload()} className="fa" icon={faThumbsUp} />
        <FontAwesomeIcon onClick={() => window.location.reload()} className="fa2" icon={faThumbsDown} />
      </div>
    );
  }
}
